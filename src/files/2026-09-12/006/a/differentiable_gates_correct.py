# differentiable_gates_correct.py
...
Initial loss (random gates): 0.2618
...
=== What gate did each junction converge to? ===
junction 1 (a,b): chose 'xor' with 99.3% confidence
junction 2 (c,d): chose 'xnor' with 99.4% confidence
center (n1,n2): chose 'xnor' with 98.5% confidence
'''

'''
That fixed it completely — look at that training curve: loss started at 0.26 (basically guessing), and by step 100 it had collapsed to 0.0006, landing at a final loss of 0.000112 — essentially perfect.
'''
